...
extern NSString *const SWRLSettingContentShowDelay;         // Number of additional seconds to hold content after loading is complete. Default is 2.0 
...
extern NSString *const SWRLSettingBeaconThreshold;          // Global RSSI threshold.  Default: -95 
...
extern NSString *const SWRLSettingBeaconUuidsAlways;        // Comma separated list of UUIDs to always listen for (ibeacon). Default is 0c900860-7e44-9182-186d-5c49ad933f81 (Swirl UUID). 
extern NSString *const SWRLSettingBeaconUuids;              // List of region based iBeacon UUIDS. Varies by region. 
extern NSString *const SWRLSettingBeaconMaxUuids;           // List of region based iBeacon UUIDS. Varies by region. 
...
extern NSString *const SWRLSettingBeaconResolveEddystoneUID;// Flag to control if Eddystone UID beacons are resolved with swirl backend. Default:NO 
